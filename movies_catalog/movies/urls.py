...
from .views import movies_list, register_movie, movie_detail, movies_list_with_search, redirect_to_chat
...
urlpatterns = [
    ...
    path('chat/<int:movie_id>/', redirect_to_chat, name='redirect_to_movie_chat'),
